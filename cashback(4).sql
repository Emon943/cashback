...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2017 at 07:48 AM
...
(41, 'Motiur', 'Rahman', 'motiur943@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '87'),
(42, 'Mony', 'Rahman', 'cashback@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '14'),
(43, 'Motiur', 'Motiur', 'abc@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '100'),
(44, 'Mony', 'abm', 'shahedbrur.cse@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '82');

-- --------------------------------------------------------

--
-- Table structure for table `refferal_member`
--

CREATE TABLE `refferal_member` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `refferal_member`
--

INSERT INTO `refferal_member` (`id`, `f_name`, `l_name`, `email_address`, `password`, `ref_id`) VALUES
(3, 'Mony', 'Motiur', 'shahedbrur.cse@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 87),
(4, 'Mony', 'Rahman', 'cashback@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 100),
(5, 'Mony', 'Rahman', 'shahedbrur.cse@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 82);
...
--
-- Indexes for table `refferal_member`
--
ALTER TABLE `refferal_member`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `members_details`
  MODIFY `member_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
-- AUTO_INCREMENT for table `refferal_member`
--
ALTER TABLE `refferal_member`
