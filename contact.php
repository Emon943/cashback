...
<head>
        ...
        <script type="text/javascript" src="../jwpsrv.com/library/czgAhjdJEeKuzSIACp8kUw.js"></script>

<!-- Facebook Like Thumbnail -->
<meta property="og:image" content="http://cashbackkaboom.com/images/fb_logo.png" />
<!-- End Facebook Like Thumbnail -->
<!-- BELOW IS USED FOR SOCIAL LOGIN -->
<script type="text/javascript">
  var oneall_subdomain = 'cashbackkaboom';
  var oneall_js_protocol = (("https:" == document.location.protocol) ? "https" : "http");
  document.write(unescape("%3Cscript src='"+oneall_js_protocol+"://"+oneall_subdomain+".api.oneall.com/socialize/library.js' type='text/javascript'%3E%3C/script%3E"));
</script>
<!-- ABOVE IS USED FOR SOCIAL LOGIN -->
</head>
...
<div id="header">
            ...
            <div class="account_menu">
                <div class="account_dropdown">
                        ...
                        <div class="login_signup">
                            <a href="login.php" class="ignore-register-modal" >Log In</a> | <a href="index-2.php">Sign Up</a>
                        </div>
    ...
    <div class="wrap">
        <div class="inner">
            ...
            <div id="logo"><a href="index.php" class="ignore-register-modal"><img src="images/header/logo.png" alt="Cash Back Kaboom" title="Cash Back Kaboom" border="0" /></a></div>
			...
			<div class="wrap">
				...
				<div class="featuredrop_col">
						<ul>
														...
														<li>
								<a href="view_retailer06ce.html?rid=773"><img src="img/uploads/yq57kqaap5jddghra0z1_1461082715.png" width="100px" height="32px" alt="1-800-FLOWERS" title="1-800-FLOWERS" border="0" /> <span class="cash_back">3% Cash Back</span></a>
							</li>
														<li>
								<a href="view_retailer7857.html?rid=38287"><img src="img/uploads/402sx7cfhmixma39qdsc_1411412711.jpg" width="100px" height="32px" alt="Nunn Bush Canada" title="Nunn Bush Canada" border="0" /> <span class="cash_back">5% Cash Back</span></a>
							</li>
														<li>
								<a href="view_retailerfe0e.html?rid=2697106"><img src="img/uploads/q923v9qvedtjkrup0f29_1415479488.jpg" width="100px" height="32px" alt="HBO Store" title="HBO Store" border="0" /> <span class="cash_back">2% Cash Back</span></a>
							</li>
														<li>
								<a href="view_retailer4326.html?rid=237343"><img src="img/uploads/yrhhu031lpvumpxc9lfr_1417724337.jpg" width="100px" height="32px" alt="PC Mall" title="PC Mall" border="0" /> <span class="cash_back">0.8% Cash Back</span></a>
							</li>
													</ul>
...
<script type="text/javascript">
	...
	<div id="contact">
		<h1>Contact Us</h1>
		<img id="contact_divider" src="img/images/divider.jpg" alt="divider" />
		
		<p> Hey Kaboomers - We ask members to please read through the <a class="ignore-register-modal" href="faq.php">FAQS here</a>  before submitting an online support request, as you may find any question you have about Cash Back Kaboom answered there. </p>


		
		
		<!-- <form>
			<div class="support_options"><input type="radio" name="r1" value="1" checked="checked" onclick="showDiv1();"/>General Inquiries</div>
			<div class="support_options"><input type="radio" name="r1" value="2" onclick="showDiv2();"/>Where Is My Cash Back?</div>
			<div style="clear:both;"></div><br />
		</form> -->
	
	<div id="general">
		<form action="#" method="post">
				<input name="fname" class="textbox" type="text" placeholder="Your Name" value="" size="25" />
		      	<input name="email" class="textbox" type="text" placeholder="Email Address" value="" size="25" />
				<textarea rows="10" cols="50" class="textbox2" placeholder="Message" name="umessage"></textarea>
				<input type="hidden" name="action" id="action" value="contact" />
				<input type="hidden" name="gencontact" id="gencontact" value="gencontact" />
		  		<input style="margin-left: 150px;" type="submit" id="contact_us_button" name="Submit" value="SEND MAIL" />
	  	</form>
	</div>

		<div id="cashback" style="display: none;">
		<form action="#" method="post">
				<input name="fnamecash" class="textbox" type="text" placeholder="Your Name" value="" size="25" />
		      	<input name="emailcash" class="textbox" type="text" placeholder="Email Address" value="" size="25" />
		      	<input name="store" class="textbox" type="text" placeholder="Store Name"  size="25" />
		      	<input name="purchasedate" class="textbox" type="text" placeholder="Date of Purchase" size="25" />
		      	<input name="ordernum" class="textbox" type="text" placeholder="Order #" size="25" />
		      	<input name="purchase_subtotal" class="textbox" type="text" placeholder="Purchase Subtotal"  size="25" />
				<textarea rows="10" cols="50" class="textbox2" placeholder="Paste the text of your order confirmation from the store here.  We must be able to view this information in order to research your inquiry." name="umessagecash"></textarea>
				<input type="hidden" name="action" id="action" value="contact" />
				<input type="hidden" name="wheresthecash" id="wheresthecash" value="wheresthecash" />
		  		<input style="margin-left: 150px;" type="submit" id="contact_us_button" name="Submit" value="SEND MAIL" />
	  	</form>
	</div>
  </div>
