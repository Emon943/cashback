			...
			<div class="wrap">
				...
				<div class="featuredrop_col">
						<ul>
														...
														<li>
								<a href="view_retailer1e40.html?rid=3070943"><img src="img/uploads/1uhac1czwl9gc3rp2dav_1417725244.jpg" width="100px" height="32px" alt="Radisson Hotels" title="Radisson Hotels" border="0" /> <span class="cash_back">4.8% Cash Back</span></a>
							</li>
														<li>
								<a href="view_retailer5d49.html?rid=4392552"><img src="img/img/noimg.html" width="100px" height="32px" alt="GE Appliance Parts" title="GE Appliance Parts" border="0" /> <span class="cash_back">$2.5 Cash Back</span></a>
							</li>
														<li>
								<a href="view_retailer2312.html?rid=38148"><img src="img/uploads/7x3soquvqbfqw4wgjqho_1406734270.jpg" width="100px" height="32px" alt="High Sierra" title="High Sierra" border="0" /> <span class="cash_back">4% Cash Back</span></a>
							</li>
														<li>
								<a href="view_retailer49d6.html?rid=3071013"><img src="img/uploads/rbvook0rclie2zd66hnp_1414182030.jpg" width="100px" height="32px" alt="Country Inns &amp; Suites" title="Country Inns &amp; Suites" border="0" /> <span class="cash_back">1.2% Cash Back</span></a>
							</li>
													</ul>
...
<div id="column_center">
	...
	<p>Please enter your email address below and we will send you an email that contains your new password.</p>
				<label>Your email address:</label>
            <input type="text" class="textbox" name="email" size="25" value="" />
