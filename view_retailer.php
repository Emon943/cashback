                            ...
                            <ul id="categories">
                                ...
                                <ul style='padding-left:0px;margin:0;'>
                                    <?php for ($i = 0; $i < count($res); $i++) {?>
                                        <li>
                                            <a href="retailers-guest.php?/<?php echo $res[$i][" cat_id "];?>">
            ...
            <div id="column_center">
                <div id="view_retailer">
                    ...
                    <table align="center" width="100%" border="0" cellspacing="0" cellpadding="5">
                        <tr class="odd">
                            <td width="125" align="center" valign="middle">
                                ...
                                <div id="shop_now_padding" class="retailview_imagebox">
                            ...
                            <td valign="top">
                                <p class="viewretailer_description">
                                    <?php echo $row1[0]["shop_des"];?>
                                </p>
                                ...
                                <p>
									...
									<!--<button style="padding:8px 20px;font-size:14px;background:#08551F;color:#F1B539;border:2px solid #F1B539; cursor: pointer;">Condition</button>
									<button type="button" class="btn btn-default" data-toggle="tooltip" data-placement="right" title="Tooltip on right">Tooltip on right</button>-->
									<div class="tooltip"><b>CONDITION!!!</b>
									<span class="tooltiptext"> logo
										Return to Homepage
										The easiest way to
										SAVE MONEY and MAKE MONEY
										on stuff you already buy!

										Try it now, It's free! </span>
									</div>
                    ...
                    <div id="free_shipping" class="tab_content">
                        <p align='center'>There no coupons at this time.</p>
                    </div>
